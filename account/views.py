...
class RegistrtionView(FormView):
    ...
    def form_valid(self, form):
        ...
        user.is_active = False #acoount is inactive untill email is verified
...
class CustomPasswordResetView(FormView):
    ...
    def form_invalid(self, form):
        messages.warning(self.request,'No account with that email exist')
